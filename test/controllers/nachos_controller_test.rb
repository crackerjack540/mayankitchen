...
class NachosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nacho" do
    assert_difference('Nacho.count') do
      post nachos_url, params: { nacho: { description: @nacho.description, price: @nacho.price, title: @nacho.title } }
    end
  ...
  test "should update nacho" do
    patch nacho_url(@nacho), params: { nacho: { description: @nacho.description, price: @nacho.price, title: @nacho.title } }
