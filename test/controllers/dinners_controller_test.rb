...
class DinnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dinner" do
    assert_difference('Dinner.count') do
      post dinners_url, params: { dinner: { description: @dinner.description, title: @dinner.title } }
    end
  ...
  test "should update dinner" do
    patch dinner_url(@dinner), params: { dinner: { description: @dinner.description, title: @dinner.title } }
