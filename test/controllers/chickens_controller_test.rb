...
class ChickensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chicken" do
    assert_difference('Chicken.count') do
      post chickens_url, params: { chicken: { description: @chicken.description, price: @chicken.price, title: @chicken.title } }
    end
  ...
  test "should update chicken" do
    patch chicken_url(@chicken), params: { chicken: { description: @chicken.description, price: @chicken.price, title: @chicken.title } }
